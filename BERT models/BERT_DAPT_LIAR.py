...
class BertForSequenceClassification(nn.Module):
    ...
    def __init__(self, num_labels=2): # Change number of labels here.
        ...
        self.bert = AutoModel.from_pretrained("allenai/news_roberta_base")
    ...
    def forward_once(self, input_ids, token_type_ids=None, attention_mask=None, labels=None):
        _,output_1 = self.bert(input_ids, token_type_ids, attention_mask, return_dict=False)
        
        pooled_output = self.dropout(output_1)

        return pooled_output

    def forward(self, input_ids1,  input_ids3, credit_sc):
        ...
        out = torch.cat((output1, output3), 1)
        #print(out.shape)
...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            # Iterate over data.
            for inputs, fakeness in tqdm(dataloaders_dict[phase]):
